...
- 🌎 **Cultural & Seasonal Recipes:** Get recipes for different cuisines or seasonal ingredients.
- 🧃 **Leftover Ingredient Recipes:** Generate recipes using leftover ingredients to minimize waste.
- 🤖 **Gemini-Powered Recipes:** Receive recipes generated by Google's Gemini AI model.
- 🧑‍💻 **Interactive UI:** Clean and intuitive interface built using Streamlit.
